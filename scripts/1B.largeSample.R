...
{ 
  ...
  if (pilot == 1) {
    ...
    ntree = 100L; nmin = round(n^0.5/4.5 + 1, 0) ; nmin.t = round(n^0.5/1.2 + 1, 0); nfold = 10   # nminD (5/8)       # tree parameters
    ## n = 100, 200, 400, 800, 1600; nmin = 2, 4, 5, 7, 10; nmin.t = 9, 13, 18, 25, 34
    # ntree = 100L; nmin = round(n^0.55/5, 0) ; nmin.t = round(n^0.55/1.2, 0); nfold = 10   # nminC (5/7)       # tree parameters
    ## n = 100, 200, 400, 800, 1600; nmin = 3, 4, 5, 8, 11; nmin.t = 10, 15, 22, 33, 48
    # ntree = 100L; nmin = round(n^0.6/6, 0) ; nmin.t = round(n^0.6/1.5, 0); nfold = 10   # nminB (5/6)       # tree parameters
    ## n = 100, 200, 400, 800, 1600; nmin = 3, 4, 6, 9, 14; nmin.t = 11, 16, 24, 37, 56
    # ntree = 100L; nmin = round(n^0.8/16, 0) ; nmin.t = round(n^0.8 /5, 0); nfold = 10   # nminA (5/5)       # tree parameters
